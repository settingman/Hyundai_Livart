               ...
               <div class="leaderboard-card">
                  ...
                  <div class="leaderboard-card__body">
                     <div class="text-center">
                        <img src="${item.photo_url }" class="circle-img mb-2" alt="User Img" onclick="javascript:location.href='/livart/productdetail?p_id=${item.p_id}';" 
                        style="cursor:pointer;">
                        <h5 class="mb-0">${item.p_name }</h5>
                        <p class="text-muted mb-0"><fmt:formatNumber
                                                      value="${ item.p_price - (item.p_price * (item.p_discount / 100))}"
                                                      type="number" /><span>원</span></p>
                        <hr>
                        <div class="d-flex justify-content-between align-items-center">
                           <span><i class="fa fa-map-marker"></i> 재 구매 : ${item.rebuycount}회</span>
                           <span class="product-item-tag__item product-item-tag__item--red" >BEST</span>
                        </div>
                     </div>
                  </div>
               </div>
               ...
               <tr>
                  <td>
                     <div class="d-flex align-items-center">
                        <img src="${item.photo_url }" class="circle-img circle-img--small mr-2" alt="User Img" onclick="javascript:location.href='/livart/productdetail?p_id=${item.p_id}';" 
                        style="cursor:pointer;">
                  ...
                  <td>
                     <div class="d-flex align-items-baseline">
                        <h4 class="mr-1"><fmt:formatNumber
                                                      value="${item.p_price }"
                                                      type="number" /><span class="unit">원</h4>
                     </div>
                  </td>
                  ...
                  <td><fmt:formatNumber
                                                      ...
                                                      type="number" />원</td>
                  <td>
                     <button class="btn btn-success btn-sm">${item.rebuycount}회</button>
                  </td>
               </tr>
               </c:if>
               </c:forEach>

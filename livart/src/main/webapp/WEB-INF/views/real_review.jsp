...
<meta charset="UTF-8">
 <meta charset="utf-8">
    ...
    <link rel="stylesheet" href="https://static.hyundailivart.co.kr/assets/css/twentytwenty.css?ver=20221017"
        media="all">
 ...
 <header class="header header-style-www" id="header">
    <div class="header-logo">
      <div class="container">
        ...
        <a href="https://www.hyundailivart.co.kr/community" class="header-logo__community">
          <h1>LIVART</h1>
        </a>
        <a href="https://www.hyundailivart.co.kr/community" class="header-logo__community-sub">
          <h1>커뮤니티</h1>
        </a>
        ...
        <ul class="header-member-menu">
          ...
          <li>
            <form id="logoutForm" name="logoutForm" action="https://www.hyundailivart.co.kr/logout" method="post">
              <a href="javascript:$.eshopfront.hpnt.logout();" class="header-member-menu__btn icon i-gnb_mem6"><i
                  class="icon-gnb_mem6"></i><span>로그아웃</span></a>
              <div>
                <input type="hidden" name="_csrf" value="08782681-7be7-47d1-8ccb-3307a2da6d19">
              </div>
            </form>
            <div style="display:none">
              <form id="logoutForm2" name="logoutForm2" action="/logout" method="post">
                <a href="javascript:$.eshopfront.hpnt.logout();" class="header-member-menu__btn icon i-gnb_mem6"><i
                    class="icon-gnb_mem6"></i><span>로그아웃</span></a>
                <div>
                  <input type="hidden" name="_csrf" value="08782681-7be7-47d1-8ccb-3307a2da6d19">
          ...
          <li>
            <a href="https://www.hyundailivart.co.kr/mypage/main" class="header-member-menu__btn icon i-gnb_mem1"><i
                class="icon-gnb_mem1"></i><span>마이페이지</span></a>
          </li>
          ...
          <li>
            <a href="https://www.hyundailivart.co.kr/csCenter/shopMgmt"
              class="header-member-menu__btn icon i-gnb_mem4"><i class="icon-gnb_mem4"></i><span>매장찾기</span></a>
          </li>
          <li>
            <a href="https://www.hyundailivart.co.kr/csCenter/shopResev"
              class="header-member-menu__btn icon i-gnb_mem7"><i class="icon-gnb_mem7"></i><span>방문상담예약</span></a>
          </li>
          <li>
            <a href="https://www.hyundailivart.co.kr/csCenter/main" class="header-member-menu__btn icon i-gnb_mem5"><i
      ...
      <div class="gnb-category-wrap">
        <div class="fullmenu-bar">
          <div class="container clear">
            ...
            <a href="javascript:" class="button button-comm-write"><i class="ico-comm_content"></i>콘텐츠
              등록</a>
          </div>
        </div>
    ...
    <div class="container">
      ...
      <section class="comm-contents-wrap">
        ...
        <header class="comm-contents-header clear">
          <span class="comm-contents-header__img">
          ...
          <span class="comm-contents-header__top">

            <em class="comm-contents-header__date">${realReviewVO.review_date }</em>


            <em class="comm-contents-header__bar">|</em>
            <em class="comm-contents-header__addr">
              </em>

          </span>

          <h3 class="comm-contents-header__title"> ${realReviewVO.review_title }
          </h3>




          <span class="fr comm-user__writer comm-user__writer--level
            flower">
            ${realReviewVO.user_user_id }
          </span>
        ...
        <div class="comm-contents-filters__wrap">
          <div class="comm-contents-filters__inner">
            ...
            <dl class="comm-contents-filters__dl">
              ...
              <dd class="comm-contents-filters__dd">
                ${realReviewVO.review_style }
              </dd>
            </dl>
            <dl class="comm-contents-filters__dl">
              <dt class="comm-contents-filters__dt">함께</dt>
              <dd class="comm-contents-filters__dd">
                ${realReviewVO.together }
              </dd>
            </dl>
          </div>
        </div>
        ...
        <div class="comm-contents-hmenu-wrap">
          ...
          <div class="comm-contents-hmenu__item">
            <span class="comm-contents-hmenu__item-icon">
              <i class="ico-search"></i>
            </span>
            <span class="comm-contents-hmenu__item-text">
              <strong>조회수</strong>
              <span>1</span>
            </span>
          </div>
          ...
          <!-- //조회수 -->
          <!-- 좋아요 -->
          <button type="button" class="comm-contents-hmenu__item button-comm-hmenu-like ">
            <span class="comm-contents-hmenu__item-icon">
              <i class="ico-like"></i>
            </span>
            <span class="comm-contents-hmenu__item-text">
              <strong class="comm-contents-hmenu__item-text__title">좋아요</strong>
              <span class="comm-contents-hmenu__item-text__num">0</span>
            </span>
          </button>
          <!-- //좋아요 -->
          <!-- //좋아요 -->
        ...
        <div class="product-item product-item--small __layout02">
          <div class="product-item-image">
            해당 제품 사진 불러오기,
            해당 제품으로 이동 앵커
            <img class="image" alt="[HM] 칸토나 소파 패브릭 일반형 6인 코너형 고스트샤크그레이"
          ...
          <a href="/p/P200106979">
            <div class="product-item-content">
              <div class="product-item-header">
                <span class="product-item-header__brand">제품 브랜드 불러오기</span>
                <span class="product-item-header__name text-ellipsis-2">제품명 불러오기</span>
              </div>
              <div class="product-item-price">
                ...
                <div class="product-item-price__price--wrap">
                  ...
                  <span class="product-item-price__price">할인된 가격불러오기<span class="unit">원</span></span>



                  <del class="product-item-price__price--del">할인전 가격 불러오기<span class="unit">원</span></del>
      ...
      <div class="button-area item-button-wrap is-centered">
        <a href="javascript:;" class="button is-primary is-outlined is-large" disabled="">이전 글</a>
        <a href="/livart/review" class="button is-primary is-outlined is-large">목록</a>
        <a href="javascript:;" class="button is-primary is-outlined is-large" disabled="">다음 글</a>
      </div>
    ...
    <div class="footer-top">
      <div class="container">
        ...
        <div class="footer-top-menu">
          <ul>
            <li><a class="footer-top-menu__link" href="https://company.hyundailivart.co.kr/ko/index">회사소개</a></li>
            <li><a class="footer-top-menu__link" href="/footerTermInfo?type=1"><strong>개인정보
                  처리방침</strong></a></li>
            <li><a class="footer-top-menu__link" href="/footerTermInfo?type=3">위치정보 이용약관</a></li>
            <li><a class="footer-top-menu__link" href="/footerTermInfo?type=4">영상정보처리기기 운영/관리방침</a></li>
            <li><a class="footer-top-menu__link" href="/footerTermInfo?type=2">이용약관</a></li>
            <li><a class="footer-top-menu__link"
                href="http://www.ehyundai.com/newPortal/ir/ETH/ETH000001.do?ir=3">경영이념</a></li>
            <li><a class="footer-top-menu__link" href="https://company.hyundailivart.co.kr/ko/statements">투자정보</a></li>
            <li><a class="footer-top-menu__link" href="https://recruit.ehyundai.com/index.nhd">인재채용</a></li>
            <li><a class="footer-top-menu__link" href="https://www.hyundailivart.co.kr/csCenter/agency">제휴 및
                대리점 개설안내</a></li>
          </ul>
        </div>
        <!-- //footer-top-menu -->
        ...
        <div class="footer-family-site fr"><button class="button-family-site">FAMILY SITE<i
              class="icon-arrow-down-white"> </i></button>
        </div>
  ...
  <section class="quick is-community" style="left: 0px; right: inherit;">
    <!-- s :  Top버튼 -->
    <div class="quick-top">
      <a href="#gnb" class="button-quick-top"><i class="ico-arrow-up"></i><span class="sr-only">맨 위로
          이동</span></a>
    </div>
    <!-- e :  Top버튼 -->
      ...
      <ul class="quick-menu">
        <li>
          <a href="https://www.hyundailivart.co.kr/cart" class="quick-menu-item icon" id="quickmenu1">
            <span class="quick-menu-item__icon"> <i class="icon-quick1"></i><em
                class="quick-menu__num viewCartCnt"></em> </span>
            ...
            <div class="swiper-container">
              <ul class="swiper-wrapper">
                ...
                <li class="swiper-slide">
                  ...
                  <button type="button" data-val="P200106979" class="btn-del"><span class="sr-only">삭제</span></button>
                </li>
        ...
        <li>
          <a href="https://plus.kakao.com/talk/bot/@%ED%98%84%EB%8C%80%EB%A6%AC%EB%B0%94%ED%8A%B8/%EC%B1%97%EB%B4%87%EC%8B%9C%EC%9E%91"
            class="quick-menu-item icon" target="_blank" rel="noopener noreferrer">
            <span class="quick-menu-item__icon">
